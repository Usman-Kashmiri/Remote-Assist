...
! function(e, t) { "object" == typeof exports && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t((e = e || self).window = e.window || {}) }(this, function(e) {
    ...
    function P(t, e) {
        var r = e.s,
            ...
            o = v.indexOf(t),
            i = n === ot.sc ? 1 : 2;
        return ~o || (o = v.push(t) - 1), v[o + i] || (v[o + i] = O(t, r) || (N(t) ? n : function(e) { return arguments.length ? t[r] = e : t[r] }))
    }
    ...
    function pb(l, e) {
        function Ye(e, t, r, n, o) {
            var i = Ye.tween,
                a = t.onComplete,
                s = {};
            return i && i.kill(), c = Math.round(r), t[p] = e, (t.modifiers = s)[p] = function(e) { return (e = K(f())) !== c && e !== u && 2 < Math.abs(e - c) ? (i.kill(), Ye.tween = 0) : e = r + n * i.ratio + o * i.ratio * i.ratio, u = c, c = K(e) }, t.onComplete = function() { Ye.tween = 0, a && a.call(i) }, i = Ye.tween = Se.to(l, t)
        }
        var c, u, f = P(l, e),
            p = "_scroll" + e.p2;
        return l[p] = f, l.addEventListener("wheel", function() { return Ye.tween && Ye.tween.kill() && (Ye.tween = 0) }, { passive: !0 }), Ye
    }
    var Se, i, Me, ke, _e, Pe, o, a, s, l, Ee, Ne, Ae, c, Be, Ie, u, Le, f, p, d, Re, ze, r, We, Ve, g, h, De = 1,
        ...
        z = function _refreshAll(e, t) {
            if (!je || e) {
                h = !0;
                var r = A("refreshInit");
                Re && ee.sort(), t || R(), lt.forEach(function(e) { return e.refresh() }), r.forEach(function(e) { return e && e.render && e.render(-1) }), v.forEach(function(e) { return "function" == typeof e && (e.rec = 0) }), a.pause(), h = !1, A("refresh")
    ...
    var ee = (ScrollTrigger.prototype.init = function init(S, M) {
        if (this.progress = this.start = 0, this.vars && this.kill(1), Ue) {
            var d, n, f, k, _, E, A, B, I, L, R, e, z, D, F, H, j, t, U, g, Z, q, h, $, v, m, r, b, x, K, o, p, y, G, ee, te, re = (S = va(V(S) || X(S) || S.nodeType ? { trigger: S } : S, st)).horizontal ? nt : ot,
                w = S.onUpdate,
                C = S.toggleClass,
                i = S.id,
                ne = S.onToggle,
            ...
            we.media = Ve, ce *= 45, we.scroller = he, we.scroll = P(he, re), k = we.scroll(), we.vars = S, M = M || S.animation, "refreshPriority" in S && (Re = 1), l.tweenScroll = l.tweenScroll || { top: pb(he, ot), left: pb(he, nt) }, we.tweenTo = d = l.tweenScroll[re.p], M && (M.vars.lazy = !1, M._initted || !1 !== M.vars.immediateRender && !1 !== S.immediateRender && M.render(0, !0, !0), we.animation = M.pause(), M.scrollTrigger = we, (o = X(a) && a) && (K = Se.to(M, { ease: "power3", duration: o, onComplete: function onComplete() { return s && s(we) } })), b = 0, i = i || M.vars.id), lt.push(we), pe && (Y(pe) && !pe.push || (pe = { snapTo: pe }), "scrollBehavior" in Pe.style && Se.set(ve ? [Pe, _e] : he, { scrollBehavior: "auto" }), f = W(pe.snapTo) ? pe.snapTo : "labels" === pe.snapTo ? function _getClosestLabel(t) { return function(e) { return Se.utils.snap(ya(t), e) } }(M) : "labelsDirectional" === pe.snapTo ? function _getLabelAtDirection(o) {
                ...
                if (Math.abs(we.getVelocity()) < 10 && !Ie && Oe !== we.scroll()) {
                    var e = M && !ge ? M.totalProgress() : we.progress,
                        ...
                        c = pe.onComplete,
                        u = d.tween;
                    if (i <= A && E <= i && a !== i) { if (u && !u._initted && u.data <= Math.abs(a - i)) return;!1 === pe.inertia && (r = o - we.progress), d(a, { duration: p(Je(.185 * Math.max(Je(n - e), Je(o - e)) / t / .05 || 0)), ease: pe.ease || "power3", data: Math.abs(a - i), onInterrupt: function onInterrupt() { return y.restart(!0) && l && l(we) }, onComplete: function onComplete() { Oe = we.scroll(), b = x = M && !ge ? M.totalProgress() : we.progress, ue && ue(we), c && c(we) } }, i, r * z, a - i - r * z), s && s(we, d.tween) }
                ...
                var t = !1 !== e || !we.enabled,
                    r = Be;
                t !== we.isReverted && (t && (we.scroll.rec || (we.scroll.rec = we.scroll()), ee = Math.max(we.scroll(), we.scroll.rec || 0), G = we.progress, te = M && M.progress()), B && [B, I, L, R].forEach(function(e) { return e.style.display = t ? "none" : "block" }), t && (Be = 1), we.update(t), Be = r, ae && (t ? function _swapPinOut(e, t, r) {
                ...
                if (!Be && we.enabled || t)
                    if (ae && e && je) Ca(ScrollTrigger, "scrollEnd", Va);
                        ...
                        f && f.forEach(function(e) { return e.revert(!1) }), we.start = E, we.end = A, (k = _ = we.scroll()) < ee && we.scroll(ee), we.revert(!1), Be = 0, M && ge && M._initted && M.progress() !== te && M.progress(te, !0).render(M.time(), !0, !0), G !== we.progress && (K && M.totalProgress(G, !0), we.progress = G, we.update()), ae && se && (j._pinOffset = Math.round(we.progress * q)), oe && oe(we)
                    }
            }, we.getVelocity = function() { return (we.scroll() - _) / (He() - Ae) * 1e3 || 0 }, we.update = function(e, t) {
            ...
            }, we.enable = function(e, t) { we.enabled || (we.enabled = !0, Ca(he, "resize", Oa), Ca(he, "scroll", Na), u && Ca(ScrollTrigger, "refreshInit", u), !1 !== e && (we.progress = G = 0, k = _ = Oe = we.scroll()), !1 !== t && we.refresh()) }, we.getTween = function(e) { return e && d ? d.tween : K }, we.disable = function(e, t) {
                ...
                var r = lt.indexOf(we);
                lt.splice(r, 1), r === Le && 0 < ut && Le--, r = 0, lt.forEach(function(e) { return e.scroller === we.scroller && (r = 1) }), r || (we.scroll.rec = 0), M && (M.scrollTrigger = null, e && M.render(-1), t || M.kill()), B && [B, I, L, R].forEach(function(e) { return e.parentNode && e.parentNode.removeChild(e) }), ae && (n && (n.uncache = 1), r = 0, lt.forEach(function(e) { return e.pin === ae && r++ }), r || (n.spacer = 0))
            }, we.enable(!1, !1), M && M.add && !z ? Se.delayedCall(.01, function() { return E || A || we.refresh() }) && (z = .01) && (E = A = 0) : we.refresh()
        ...
        if (!i && (Se = e || M(), L() && window.document && (Me = window, ke = document, _e = ke.documentElement, Pe = ke.body), Se && (Ee = Se.utils.toArray, Ne = Se.utils.clamp, ze = Se.core.suppressOverwrites || J, Se.core.globals("ScrollTrigger", ScrollTrigger), Pe))) {
            s = Me.requestAnimationFrame || function(e) { return setTimeout(e, 16) }, Ca(Me, "wheel", Na), o = [Me, ke, _e, Pe], Ca(ke, "scroll", Na);
            var t, r = Pe.style,
                n = r.borderTop;
            r.borderTop = "1px solid #000", t = it(Pe), ot.m = Math.round(t.top + ot.sc()) || 0, nt.m = Math.round(t.left + nt.sc()) || 0, n ? r.borderTop = n : r.removeProperty("border-top"), c = setInterval(Ma, 200), Se.delayedCall(.5, function() { return De = 0 }), Ca(ke, "touchcancel", J), Ca(Pe, "touchstart", J), Ba(Ca, ke, "pointerdown,touchstart,mousedown", function() { return Ie = 1 }), Ba(Ca, ke, "pointerup,touchend,mouseup", function() { return Ie = 0 }), u = Se.utils.checkPrefix("transform"), j.push(u), i = He(), a = Se.delayedCall(.2, z).pause(), d = [ke, "visibilitychange", function() {
                var e = Me.innerWidth,
                    t = Me.innerHeight;
                ke.hidden ? (f = e, p = t) : f === e && p === t || Oa()
            }, ke, "DOMContentLoaded", z, Me, "load", function() { return je || z() }, Me, "resize", Oa], U(Ca)
        }
        return i
    }, ScrollTrigger.defaults = function defaults(e) { for (var t in e) st[t] = e[t] }, ScrollTrigger.kill = function kill() { Ue = 0, lt.slice(0).forEach(function(e) { return e.kill(1) }) }, ScrollTrigger.config = function config(e) {
    ...
    }, ScrollTrigger.matchMedia = function matchMedia(e) { var t, r, n, o, i; for (r in e) n = E.indexOf(r), o = e[r], "all" === (Ve = r) ? o() : (t = Me.matchMedia(r)) && (t.matches && (i = o()), ~n ? (E[n + 1] = $(E[n + 1], o), E[n + 2] = $(E[n + 2], i)) : (n = E.length, E.push(r, o, i), t.addListener ? t.addListener(Ua) : t.addEventListener("change", Ua)), E[n + 3] = t.matches), Ve = 0; return E }, ScrollTrigger.clearMatchMedia = function clearMatchMedia(e) { e || (E.length = 0), 0 <= (e = E.indexOf(e)) && E.splice(e, 4) }, ScrollTrigger);
    ...
    ee.version = "3.7.1", ee.saveStyles = function(e) {
        ...
        return W(a) && (a = a(), Ca(ee, "refresh", function() { return a = t.batchMax() })), Ee(e).forEach(function(e) {
            var t = {};
            for (r in o) t[r] = o[r];
            t.trigger = e, n.push(ee.create(t))
        }), n
    }, ee.sort = function(e) { return lt.sort(e || function(e, t) { return -1e6 * (e.vars.refreshPriority || 0) + e.start - (t.start + -1e6 * (t.vars.refreshPriority || 0)) }) }, M() && Se.registerPlugin(ee), e.ScrollTrigger = ee, e.default = ee;
